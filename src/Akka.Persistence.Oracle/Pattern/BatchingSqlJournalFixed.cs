...
using Akka.Persistence.Oracle.Pattern;
...
namespace Akka.Persistence.Sql.Common.Journal
{
    ...
    public abstract class BatchingSqlJournalFixed<TConnection, TCommand> : WriteJournalBase
        ...
        where TCommand : DbCommand
    {
        ...
        private readonly CircuitBreakerFixed _circuitBreaker;
        ...
        protected BatchingSqlJournalFixed(BatchingSqlJournalSetup setup)
        {
            Setup = setup;
            ...
            _circuitBreaker = CircuitBreakerFixed.Create(
        ...
        private async Task HandleWriteMessages(WriteMessages req, TCommand command)
        {
            ...
            {
                aref.Tell(response.Item1, response.Item2);
            }
        }
